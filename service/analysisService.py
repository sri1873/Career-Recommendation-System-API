...
def recommendations(result_list1,studentId):
    ...
    convo.send_message(
        "My semester marks in these subjects are following, if i want to become a full stack dev where do i need to improve in every subject"+str(mark_gaps)+
        "Output format: [{'<subject_name>':<recommendations[str]>}]"
        )
